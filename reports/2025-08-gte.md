...
|ID|Title|Severity|
|:-:|:---|:------:|
|[H-01](https://github.com/nem0thefinder/Audits/new/main/reports#h-01-quote-token-validation-bypass-in-addrewards-enables-dos-of-protocol-operations)|Quote Token Validation Bypass in addRewards Enables DOS of Protocol Operations|HIGH|
|[H-02]()|Empty Catch Block in Pair Creation Allows Graduation DoS Attack|HIGH|
|[H-03]()|Inverted Logic in Rewards Termination Prevents Fee Recovery When All Holders Exit|HIGH|
|[M-01]()|Factory Uses Immutable LP Vault Address While Launchpad Allows Updates, Breaking Fee Calculations for All Pairs|MEDIUM|
|[M-02]()| User Rewards Permanently Lost to Launchpad|MEDIUM|
|[M-03]()| Salt Mismatch between Launchpad and Factory allowing Pool Ratio Manipulation|MEDIUM|
|[L-01]() |USDC scaling issue affect trading and vault operations|LOW|
|[L-02]() |GTL Queue-Based Withdrawal DoS|LOW|
